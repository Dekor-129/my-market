...
export default function Contacts() {
  ...
  return (
    <>
    <MainContainer title = 'Контакты' description ={'С нами можно легко связаться по указанным на странице способам.'}>
      <h2 className="text-center">Контакты</h2>
      <Container className='my-5'>
        <Row>
          <Col><h3>Вы можете написать нам свой вопрос,отзыв или предложение</h3></Col>
          <Col>
      ...
      <Container className='my-5'>
        <Row>
          <Col><strong>Телефон:</strong> <a href='tel:89105755989'><strong>8-910-575-59-89</strong></a> | | <a href='tel:89106293912'><strong>8-910-629-39-12</strong></a></Col>
        </Row>
        <Row>
          <Col lg={9}><h3>Социальные сети и мессенджеры:</h3></Col>
          <Col lg={1}>
